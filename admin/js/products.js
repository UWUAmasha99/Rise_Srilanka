$(document).ready(function(){
					...
					if (productList) {
						$.each(resp.message.products, function(index, value){
							...
							productHTML += '<tr>'+
											  ...
											  '<td><img width="60" height="60" src="../assets/prod_images/'+value.product_image+'"></td>'+
	...
	$(document.body).on('click', '.edit-product', function(){
		...
		$("input[name='e_product_image']").siblings("img").attr("src", "../assets/prod_images"+product.product_image);
