...
<style>
		body{
			...
			background-image: url("assets/prod_images/ana.jpeg");	
...
<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			...
			<a href="index.php" class=""><img src="assets/images/logo.png" alt="" width="120" height="80"> </a>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				</span>Welcome, <?php echo $_SESSION['uname']; ?></a>
	...
	<div class="one-time">
	    <div><img src="assets/images/ca1.jpg"></div>
	    <div><img src="assets/images/ca2.jpg"></div>
	    <div><img src="assets/images/ca3.jpg"></div>
  	</div>
	<!-- Slider ends -->
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; RAISE SRILANKA-2022 FOR REAL ENREPRENURS OF THE SRILANKA</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
